...
function __init__()
    ...
    JLLWrappers.@init_library_product(
        aui,
        "lib/libwx_osx_cocoau_aui-3.1-aarch64-apple-darwin20.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        baseu,
        "lib/libwx_baseu-3.1-aarch64-apple-darwin20.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        baseu_net,
        "lib/libwx_baseu_net-3.1-aarch64-apple-darwin20.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        baseu_xml,
        "lib/libwx_baseu_xml-3.1-aarch64-apple-darwin20.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        core,
        "lib/libwx_osx_cocoau_core-3.1-aarch64-apple-darwin20.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        html,
        "lib/libwx_osx_cocoau_html-3.1-aarch64-apple-darwin20.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        propgrid,
        "lib/libwx_osx_cocoau_propgrid-3.1-aarch64-apple-darwin20.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        qa,
        "lib/libwx_osx_cocoau_qa-3.1-aarch64-apple-darwin20.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        ribbon,
        "lib/libwx_osx_cocoau_ribbon-3.1-aarch64-apple-darwin20.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        richtext,
        "lib/libwx_osx_cocoau_richtext-3.1-aarch64-apple-darwin20.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        stc,
        "lib/libwx_osx_cocoau_stc-3.1-aarch64-apple-darwin20.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
    ...
    JLLWrappers.@init_library_product(
        xrc,
        "lib/libwx_osx_cocoau_xrc-3.1-aarch64-apple-darwin20.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
